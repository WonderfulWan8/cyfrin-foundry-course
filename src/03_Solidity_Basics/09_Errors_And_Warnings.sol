// if we don't wirte SPDX-License-Identifier: MIT
// the ide gonna give warning but we can still compile and deploy
...
contract SimpleStorage {
    ...
    // but if we forget to write return statement
    // the ide will give error and we can't compile
}
